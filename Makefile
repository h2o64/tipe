...
CAMLC = ocamlfind ocamlc -principal -w -40-18 -package fftw3
CAMLOPT = ocamlfind ocamlopt -principal -w -40-18 -package fftw3
...
LIBS = \
	...
	$(WITHSTR) \
	$(WITHBG) \
	~/.opam/system/lib/fftw3/fftw3.cma
...
WITHGRAPHICS = /usr/lib/ocaml/graphics.cma -cclib -lgraphics -cclib -L/usr/X11R6/lib -cclib -lX11
WITHUNIX = /usr/lib/ocaml/unix.cma
WITHSTR = /usr/lib/ocaml/str.cma
WITHSTD = /usr/lib/ocaml/stdlib.cma
WITHBG = /usr/lib/ocaml/bigarray.cma
